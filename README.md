...
- `metric_llm`이 Judge 결과를 점수화해 최적화 지표로 사용합니다. (레거시: `_legacy` 파일)
...
[4] 품질 평가 metric
    src/translation/signatures/translation_judge_legacy.py
    src/translation/metrics/translate_metric_legacy.py
...
│       ├── metrics/translate_metric_legacy.py  # Judge 기반 metric (legacy)
